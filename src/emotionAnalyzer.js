    ...
    constructor() {
        ...
        this.emotionPatterns = [
            ...
            // 重度の照れ
            {
                ...
                keywords: ['からかって', '恥ずかしい', '冗談だろ', 'バカ！', 'からかうな'],
                priority: 10,
                duration: 2000
            },
            // 中度の照れ
            ...
            // 2. 驚き系
            {
                ...
                keywords: ['え！？', 'えっ！', 'おお！', 'わっ！', 'マジか', '本当か？', '嘘だろ', 'まさか'],
                priority: 7,
                duration: 500
            },
            ...
            // 3. 呆れ系（複合感情）
            {
                ...
                keywords: ['はあ？', 'マジで言ってるのか？', '大丈夫かお前', '何それ', 'やれやれ', 'またか'],
                priority: 6,
                duration: 1200
            },
            ...
            // 真剣な注意
            {
                ...
                keywords: ['いい加減にしろ', 'ちゃんとしろよ', 'ダメだ', '気をつけろよ', 'しっかりしろ', '気をつけろ', 'やめろ'],
                priority: 5,
                duration: 1500
            },
            // 軽いツッコミ
            {
                ...
                keywords: ['ちょっと待て', 'おい', '違うぞ', 'おかしくないか？', '逆だろ', 'そうじゃない', '面倒', '黙れ', 'うるさい'],
                priority: 4,
                duration: 1000
            },
            ...
            // 失敗・困惑
            {
                ...
                keywords: ['参った', '困ったな', '困ったぞ', 'だめだった', '失敗', 'やっちゃった', 'ミスった', 'エラーが出た', 'エラーが出てる'],
                priority: 2,
                duration: 1500
            },
            // 軽い困惑
            {
                ...
                keywords: ['うーん', 'どうしよう', '心配', '不安', '微妙', '分からん', '仕方ない', 'しょうがない', 'おかしいな'],
                priority: 1,
                duration: 1000
            },
            ...
            // 6. 喜び系
            {
                ...
                keywords: ['できた', 'うまくいった', 'よし', '完了', '成功', 'えへ', 'あはは', 'ふふ', 'へへ', 'すごいな', 'いいじゃないか', '悪くない', 'やったな'],
                priority: 0,
                duration: 1500
            },
            // 完璧だ（強い成功の喜び）
